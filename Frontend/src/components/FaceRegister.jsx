...
import { Camera, RefreshCw, X, User } from 'lucide-react';
...
const FaceRegister = ({ onSuccess, onCancel }) => {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      // Backend route: /api/face-register (matching your server.js)
      await axios.post(`${API_URL}/api/face-register`, { name, embedding });
